...
waterRF = read.csv('040029_0920water.csv') 
waterSMA = read.csv('040029_0920waterSMA.csv') 
mesicRF = read.csv('040029_0920mesic.csv') 
mesicSMA = read.csv('040029_0920mesicSMA.csv')

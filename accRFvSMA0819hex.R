...
waterRF = read.csv('040029_0819water.csv') 
waterSMA = read.csv('040029_0819waterSMA.csv') 
mesicRF = read.csv('040029_0819mesic.csv') 
mesicSMA = read.csv('040029_0819mesicSMA.csv')

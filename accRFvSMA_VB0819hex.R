...
waterRF = read.csv('040029_0819waterVB.csv') 
waterSMA = read.csv('040029_0819waterSMAVB.csv') 
mesicRF = read.csv('040029_0819mesicVB.csv') 
mesicSMA = read.csv('040029_0819mesicSMAVB.csv')

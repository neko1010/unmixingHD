...
waterRF = read.csv('040029_0820waterVB.csv') 
waterSMA = read.csv('040029_0820waterSMAVB.csv') 
mesicRF = read.csv('040029_0820mesicVB.csv') 
mesicSMA = read.csv('040029_0820mesicSMAVB.csv')

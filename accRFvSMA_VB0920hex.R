...
waterRF = read.csv('040029_0920waterVB.csv') 
waterSMA = read.csv('040029_0920waterSMAVB.csv') 
mesicRF = read.csv('040029_0920mesicVB.csv') 
mesicSMA = read.csv('040029_0920mesicSMAVB.csv')
